...
if (budy.includes('gore') || budy.includes('cp')|| budy.includes('Niñas desnudas')|| budy.includes('Gore')|| budy.includes('porno de niños')|| budy.includes('CP')|| budy.includes('child porn')) return m.reply('*No voy a buscar esas mamadas enfermo de mierda*');
...
let sistema1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Snipe, tu seras ZazuBot`;
...
try {
const syms1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Snipe, tu seras ZazuBot`
